...
function Preparation() {
  return (
    <div>
      <Head>
        <title>Курсы подготовки к ЕНТ</title>
          ...
          <div className="grid grid-cols-1 md:grid-cols-12 gap-12 pt-[118px]">
            <div className="md:col-span-7">
              <div className="text-4xl font-bold ">
                ...
                <span className="text-[#30AAE2]">(в РЦТ)</span>
              </div>
              <p className="mb-8 text-xl font-medium">
                <br />
                Подготовка учащихся 10 и 11 классов СШ к ЕНТ (5 предметов)<br/> <br />
                Стоимость - 35000-50 000 тг. / месяц
              </p>
