...
function Admincontrolpost() {
  ...
  const url = "https://arioapi.pythonanywhere.com/u-api/student/";
  ...
  function submit(data: any) {
    ...
    formData.append("tests", "Административный контроль")
...
export default Admincontrolpost;
