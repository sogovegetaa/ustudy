...
function AboutSwiper() {
  ...
  return (
    ...
    <Image src="/images/swiper-circle.png" width={212} height={212} alt="" className="absolute right-[10%] bottom-0" />
    <Swiper
      slidesPerView={4}
      spaceBetween={0}
      centeredSlides={true}
    ...
    >
      ...
      <SwiperSlide className="flex flex-wrap">
        ...
        <SwiperText className="w-[100%!important]">
          ...
          поселках. Проведение электронного ЕНТ (140 тыс. ч.) Проведение первого
          КТ в докторантуру (5 тыс. ч.). Проведение первых тестов РФМШ, НИШ, КТЛ
          (10 тыс. чел.)
        </SwiperText>
      </SwiperSlide>
    </Swiper>
